      ...
      <div className="grid grid-cols-2 gap-2">
         <Card className="border-primary/10 bg-primary/5 shadow-none">
           <CardContent className="p-3 text-center">
             <div className="text-2xl font-bold text-primary">{results.totalJobs}</div>
             <div className="text-[10px] font-medium text-muted-foreground">Total Jobs</div>
           </CardContent>
         </Card>
      ...
      {results.jobs.slice(0, 3).length > 0 && (
         <div className="space-y-2">
           <div className="flex items-center justify-between">
             <h3 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Latest Jobs</h3>
               ...
               <Card key={job.id || idx} className="overflow-hidden shadow-sm">
                 <CardContent className="p-3">
                   <div className="flex items-start justify-between gap-2">
                      ...
                      <Badge variant="outline" className="shrink-0 text-[10px] uppercase">{job.platform}</Badge>
                   </div>
           ...
           {results.jobs.length > 3 && (
             <p className="text-center text-[10px] text-muted-foreground">...and {results.jobs.length - 3} more</p>
           )}
         </div>
      )}
